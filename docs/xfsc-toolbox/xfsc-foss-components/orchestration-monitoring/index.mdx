...
<div class="img-container">
  <Box
    ...
    href="/landingpage/xfsc-toolbox/xfsc-foss-components/orchestration-monitoring/orchestration-engine"
  />
  <Box
    name="Service Mesh Automation (Orchestration, ORC)"
    img="/landingpage/img/service_3.png"
    href="/landingpage/xfsc-toolbox/xfsc-foss-components/orchestration-monitoring/service-mash"
  />
  <Box
    name="Continuous Automated Monitoring (CAM)"
    img="/landingpage/img/monitoring.png"
    href="/landingpage/xfsc-toolbox/xfsc-foss-components/orchestration-monitoring/continuous-automated"
  />
</div>
