...
<div className="img-container">
  <Box
    ...
    img="/landingpage/img/service_1.png"
    href="/landingpage/xfsc-toolbox/xfsc-foss-components/icam-and-trust"
  />
  <Box
    name="Decenralised Catalogue and Contracting Service"
    img="/landingpage/img/service_2.png"
    href="/landingpage/xfsc-toolbox/xfsc-foss-components/decentralized-catalogue"
  />
  <Box
    name="Orchestration & Monitoring"
    img="/landingpage/img/service_3.png"
    href="/landingpage/xfsc-toolbox/xfsc-foss-components/orchestration-monitoring"
  />
  <Box name="Portal" img="/landingpage/img/service_4.png" href="/landingpage/xfsc-toolbox/xfsc-foss-components/portal" />
</div>
