...
<div class="img-container">
  <Box
    ...
    img="/landingpage/img/icam_1.png"
    href="/landingpage/xfsc-toolbox/xfsc-foss-components/icam-and-trust/authentication"
  />
  <Box
    name="Organisation CredentialManager (OCM)"
    img="/landingpage/img/icam_2.png"
    href="/landingpage/xfsc-toolbox/xfsc-foss-components/icam-and-trust/organisation-credential"
  />
  <Box
    name="Personal CredentialManager (PCM)"
    img="/landingpage/img/icam_3.png"
    href="/landingpage/xfsc-toolbox/xfsc-foss-components/icam-and-trust/personal-credential"
  />
  <Box
    name="Trust Services API (TSA)"
    img="/landingpage/img/icam_4.png"
    href="/landingpage/xfsc-toolbox/xfsc-foss-components/icam-and-trust/trust-service"
  />
  <Box
    name="Notarisation Service (NOT)"
    img="/landingpage/img/icam_5.png"
    href="/landingpage/xfsc-toolbox/xfsc-foss-components/icam-and-trust/notarisation"
  />
  <Box
    name="Trust Management Infrastructure (TRAIN)"
    img="/landingpage/img/trust.png"
    href="/landingpage/xfsc-toolbox/xfsc-foss-components/icam-and-trust/trust-management"
  />
</div>
